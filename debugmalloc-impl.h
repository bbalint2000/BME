...
/* debugmalloc singleton, storing mainstruct state */
...
/* dump data of mainstruct memory blocks allocated. */
...
static size_t debugmalloc_hash(void *address) {
     ...
     * alignment purposes. mainstruct tested architectures used 16 byte allocation. */
 ...
 * as mainstruct allocations are tracked in the list, this function can call abort()
